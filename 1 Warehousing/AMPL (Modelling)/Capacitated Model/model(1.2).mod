##################################################
#Model File For Capacitated Model (1 Warehousing)
#
#Models the assignment of customers to facilities, with considerations
...
#Defines capacity limit for the facilities
param capacity {f in Facilities}
	:= 100 * (2**(ord(f)));
	
#Loads in demands for the customers
...
#Ensures the demand of each customer is met by the facility theyre assigned to
