...
So we on the 2059th iteration, we achieved our estimate of 32412.96. Our estimator has a standard deviation of 303.8788.

From here, we use the z-score of 1.96 to calculate an interval that we can be 95% our true value is in. With our standard deviation of 303.8788, we find calculate 1.96*303.8788. So our interval is +/- 595.59.
